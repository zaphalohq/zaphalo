            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-6">
                ...
                <button
                  type='submit'
                  disabled={loading}
                  className="w-full cursor-pointer bg-green-500 text-white font-semibold py-4 px-6 rounded-xl 
           ...
           shadow-lg hover:shadow-xl group relative overflow-hidden">
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-600 text-sm">
                ...
                <button onClick={() => navigate('/register')} className="text-green-600 cursor-pointer hover:text-green-700 ml-1 underline">
                  Sign up
                </button>
              </p>
            </div>
