...
//     <div className="flex">
//       {/* Sidebar */}
//       <div className={`fixed top-0 left-0 h-screen bg-gray-800 p-5 transition-transform ${isOpen ? "translate-x-0" : "-translate-x-full"} md:relative md:translate-x-0 md:w-64`}>
//         <h2 className="text-white text-xl mb-5">Logo</h2>
...
//             className="md:hidden bg-gray-800 text-white p-2 rounded focus:outline-none"
//           >
