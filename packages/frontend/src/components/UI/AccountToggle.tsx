...
const AccountToggle = () => {
    ...
    return (
        <div className="border-b mt-2 mb-4 pb-4 border-stone-300 relative ">
            ...
            {isWorkspaceOpen ?<div className="flex flex-col gap-2 absolute w-48 rounded bg-white p-2 pt-6 border border-gray-200">
