...
const ChatsNav = () => {
    ...
    useState()
  useEffect(() => {
    const initialChatsDetails = JSON.parse(
    localStorage.getItem("chatsDetails") || '{"channelId": null}' )
    setChatsDetails(initialChatsDetails)
    console.log(initialChatsDetails);
