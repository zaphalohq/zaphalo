...
import { ExceptionHandlerConsoleDriver } from 'src/modules/exception-handler/drivers/console.driver';
// import { ExceptionHandlerSentryDriver } from 'src/modules/exception-handler/drivers/sentry.driver';
import { EXCEPTION_HANDLER_DRIVER } from 'src/modules/exception-handler/exception-handler.constants';
import {
  ASYNC_OPTIONS_TYPE,
  ConfigurableModuleClass,
  OPTIONS_TYPE,
} from 'src/modules/exception-handler/exception-handler.module-definition';
import { ExceptionHandlerService } from 'src/modules/exception-handler/exception-handler.service';
import { HttpExceptionHandlerService } from 'src/modules/exception-handler/http-exception-handler.service';
...
export class ExceptionHandlerModule extends ConfigurableModuleClass {
  static forRoot(options: typeof OPTIONS_TYPE): DynamicModule {
    const provider = {
      ...
      useValue: new ExceptionHandlerConsoleDriver(),
