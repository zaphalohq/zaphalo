...
export class BaseGraphQLError extends GraphQLError {
  ...
  declare readonly locations: ReadonlyArray<SourceLocation> | undefined;
  declare readonly path: ReadonlyArray<string | number> | undefined;
  declare readonly source: Source | undefined;
  declare readonly positions: ReadonlyArray<number> | undefined;
  declare readonly nodes: ReadonlyArray<ASTNode> | undefined;
  declare public originalError: Error | undefined;
...
export const convertGraphQLErrorToBaseGraphQLError = (
  ...
  const httpStatus = (error.extensions as any)?.http?.status;
