...
export class WaTemplateButtonsVariables1762336541445 implements MigrationInterface {
    name = 'WaTemplateButtonsVariables1762336541445'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "${schema}"."whatsappTemplateVariable" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "type" "${schema}"."whatsappTemplateVariable_type_enum" NOT NULL DEFAULT 'STATIC', "value" character varying, "dynamicField" character varying, "templateId" uuid, CONSTRAINT "PK_f5f6983414d22d4360b5f426eaa" PRIMARY KEY ("id"))`);
