...
export class New1752046587408 implements MigrationInterface {
    name = 'New1752046587408'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "${schema}"."whatsAppTemplate" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "account" character varying,
  ...
  CONSTRAINT "PK_446bdd7de9665979408947ee682" PRIMARY KEY ("id")
);`);
