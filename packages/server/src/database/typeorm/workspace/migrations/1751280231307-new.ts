...
export class New1751280231307 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "${schema}"."contacts" ADD CONSTRAINT "FK_60c505f7ac4b3dae62c6fbc486f" FOREIGN KEY ("workspaceId") REFERENCES "core"."workspace"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "${schema}"."channel" ADD CONSTRAINT "FK_bc89fbb35dc73d479b1d3455733" FOREIGN KEY ("writeUserId") REFERENCES "core"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "${schema}"."channel" ADD CONSTRAINT "FK_27622c8ed8e1371873074254bb8" FOREIGN KEY ("createUserId") REFERENCES "core"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "${schema}"."channel" ADD CONSTRAINT "FK_885f1a3a3369b4cfa36bfd2e83f" FOREIGN KEY ("workspaceId") REFERENCES "core"."workspace"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "${schema}"."broadcast" ADD CONSTRAINT "FK_5381c67c66d71724d2cd789a0f5" FOREIGN KEY ("templateId") REFERENCES "${schema}"."template"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "${schema}"."broadcast" ADD CONSTRAINT "FK_bf9b7ac3cd047bb09ef856a2fcd" FOREIGN KEY ("workspaceId") REFERENCES "core"."workspace"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "${schema}"."broadcast" DROP CONSTRAINT "FK_bf9b7ac3cd047bb09ef856a2fcd"`);
        ...
        await queryRunner.query(`ALTER TABLE "${schema}"."channel" DROP CONSTRAINT "FK_885f1a3a3369b4cfa36bfd2e83f"`);
        await queryRunner.query(`ALTER TABLE "${schema}"."channel" DROP CONSTRAINT "FK_27622c8ed8e1371873074254bb8"`);
        await queryRunner.query(`ALTER TABLE "${schema}"."channel" DROP CONSTRAINT "FK_bc89fbb35dc73d479b1d3455733"`);
        await queryRunner.query(`ALTER TABLE "${schema}"."contacts" DROP CONSTRAINT "FK_60c505f7ac4b3dae62c6fbc486f"`);
        ...
        await queryRunner.query(`DROP TABLE "${schema}"."template"`);
    }
