...
export class New1752226536627 implements MigrationInterface {
    name = 'New1752226536627'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "core"."attachment" DROP CONSTRAINT "FK_97d9ced65a2417c74f1430921a9"`);
        ...
        await queryRunner.query(`DROP TABLE "core"."whatsAppAccount"`);
        await queryRunner.query(`DROP TABLE "core"."attachment"`);
        await queryRunner.query(`DROP TABLE "core"."broadcastContacts"`);
        await queryRunner.query(`DROP TABLE "core"."broadcast"`);
        await queryRunner.query(`DROP TABLE "core"."whatsAppTemplate"`);
